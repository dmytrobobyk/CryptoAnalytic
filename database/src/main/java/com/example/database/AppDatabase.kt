...
import com.example.database.dao.NotificationsDao
import com.example.database.dao.RoiDao
import com.example.database.entity.*

@Database(entities = [DbCryptocurrencyDetails::class, DbCryptocurrency::class, DbLinks::class, DbMarketData::class, DbRoi::class, DbNotification::class], version = APP_DATABASE_VERSION)
